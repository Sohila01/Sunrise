...
async function seedDatabase() {
  try {
    ...
    await supabase.from('site_settings').insert({
      ...
      font_family: 'Cairo',
      logo_url: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?w=200&h=80&fit=crop',
      ...
      hero_panorama_url: 'https://images.unsplash.com/photo-1585059895311-9e73b4d45863?w=1920&h=600&fit=crop',
    ...
    const projects = [
      {
        ...
        location: 'المنوفية',
        crop_type: 'طماطم',
        main_image_url: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&h=300&fit=crop',
        is_featured: true,
      },
      {
        id: uuidv4(),
        ...
        location: 'الجيزة',
        crop_type: 'خيار',
        main_image_url: 'https://images.unsplash.com/photo-1464226184837-280ecc440399?w=400&h=300&fit=crop',
        is_featured: true,
      },
      {
        id: uuidv4(),
        ...
        location: 'القليوبية',
        crop_type: 'فلفل',
        main_image_url: 'https://images.unsplash.com/photo-1111621636776-ed8632f536e6?w=400&h=300&fit=crop',
        is_featured: false,
      },
      {
        id: uuidv4(),
        ...
        main_image_url: 'https://images.unsplash.com/photo-1459262838948-3e2de6c0ec05?w=400&h=300&fit=crop',
        is_featured: false,
      },
      {
        id: uuidv4(),
        ...
        location: 'دمياط',
        crop_type: 'فراولة',
        main_image_url: 'https://images.unsplash.com/photo-1543958636-5c42b97b2b78?w=400&h=300&fit=crop',
        is_featured: false,
      },
    ];
    ...
    const products = [
      {
        ...
        price: 15000.00,
        image_url: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=300&h=300&fit=crop',
        category: 'أنظمة الري',
        is_active: true,
      },
      {
      ...
      },
      {
        ...
        price: 2000.00,
        image_url: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=300&h=300&fit=crop',
      ...
      },
      {
        ...
        price: 450.00,
        image_url: 'https://images.unsplash.com/photo-1599366435932-3de48be0d226?w=300&h=300&fit=crop',
        category: 'الأجهزة',
        is_active: true,
      },
      {
      ...
      },
      {
        ...
        price: 80.00,
        image_url: 'https://images.unsplash.com/photo-1593194335519-f05dcc0c0490?w=300&h=300&fit=crop',
        category: 'المبيدات',
        is_active: true,
      },
    ];
    ...
    const media = [
      {
        id: uuidv4(),
        file_url: 'https://images.unsplash.com/photo-1585059895311-9e73b4d45863?w=800&h=600&fit=crop',
      ...
      {
        id: uuidv4(),
        file_url: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=800&h=600&fit=crop',
      ...
      {
        id: uuidv4(),
        file_url: 'https://images.unsplash.com/photo-1579154204601-01d5b6458ba8?w=800&h=600&fit=crop',
