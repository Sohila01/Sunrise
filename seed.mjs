...
async function seedDatabase() {
  try {
    ...
    const projects = [
      {
        ...
        location: 'المنوفية',
        crop_type: 'طماطم',
        main_image_url: 'https://images.unsplash.com/photo-1464226184837-280ecc440399?w=600&q=80',
        is_featured: true,
        created_at: new Date().toISOString(),
      },
      {
        ...
        location: 'الجيزة',
        crop_type: 'خيار',
        main_image_url: 'https://images.unsplash.com/photo-1563832040-a3d5e15fbb10?w=600&q=80',
        is_featured: true,
        created_at: new Date().toISOString(),
      },
      {
        ...
        location: 'القليوبية',
        crop_type: 'فلفل',
        main_image_url: 'https://images.unsplash.com/photo-1584868857006-e82e4ef14a0f?w=600&q=80',
        is_featured: false,
        created_at: new Date().toISOString(),
      },
      {
        ...
        main_image_url: 'https://images.unsplash.com/photo-1521132573892-7c8ee5bf583f?w=600&q=80',
        is_featured: false,
        created_at: new Date().toISOString(),
      },
      {
        ...
        location: 'دمياط',
        crop_type: 'فراولة',
        main_image_url: 'https://images.unsplash.com/photo-1585059895311-9e73b4d45863?w=600&q=80',
        is_featured: false,
        created_at: new Date().toISOString(),
      },
    ];
    ...
    const products = [
      {
        ...
        price: 15000.00,
        image_url: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad576?w=400&q=80',
        category: 'أنظمة الري',
        is_active: true,
        created_at: new Date().toISOString(),
      },
      {
        ...
        price: 3500.00,
        image_url: 'https://images.unsplash.com/photo-1621905167918-48416bd8575a?w=400&q=80',
        category: 'التهوية',
        is_active: true,
        created_at: new Date().toISOString(),
      },
      {
        ...
        price: 2000.00,
        image_url: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=400&q=80',
      ...
      },
      {
        ...
        price: 450.00,
        image_url: 'https://images.unsplash.com/photo-1581092918692-8d1bd32410d5?w=400&q=80',
        category: 'الأجهزة',
        is_active: true,
        created_at: new Date().toISOString(),
      },
    ...
    const media = [
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1585059895311-9e73b4d45863?w=800&q=80',
      ...
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1559056199-641a0ac8b3f4?w=800&q=80',
      ...
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad576?w=800&q=80',
      ...
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80',
      ...
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=80',
        file_name: 'products_catalog.jpg',
        file_type: 'image/jpeg',
        size: 512000,
        created_at: new Date().toISOString(),
      },
      {
        id: randomUUID(),
        file_url: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80',
        file_name: 'training_guide.jpg',
        file_type: 'image/jpeg',
        size: 2048000,
        created_at: new Date().toISOString(),
      },
